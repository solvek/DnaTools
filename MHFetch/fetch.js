...
(function() {
    ...
    function showButton(){
        ...
        btn.addEventListener('click', function() {
            fetch("https://familygraphql.myheritage.com/fetch_dna_matches_for_kit/", {
  "headers": {
    "accept": "application/json, text/plain, */*",
    "accept-language": "uk-UA,uk;q=0.9,en-US;q=0.8,en;q=0.7,ru;q=0.6,pl;q=0.5",
